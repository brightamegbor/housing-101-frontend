...
export default function AllRoutes() {
  return (
    <Routes>
      ...
      <Route path="/drafts" element={<DashboardProperties />} />
      <Route path="/favorites" element={<Others />} />
      <Route path="/notifications" element={<DashMessages />} />
      <Route path="/listings/property/new" element={<AddProperty />} />
