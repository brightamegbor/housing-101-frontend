...
class userProfile extends Component {
  ...
  modalProfile = () => {
    ...
    return (
      <div>
        <button type="button" className="editbtn mr-auto" onClick={handleOpen}>
          Edit Profile
        </button>
        <Modal
                ...
                <Form.Group>
                  <InputGroup>
                    ...
                    {/* <FieldControl
                                        ...
                                        options={{ validators: Validators.required }}
                                        render={({ handler, touched, hasError }) => ( */}
                    <Form.Control id="name" placeholder="Enter phone" />
                  </InputGroup>
                </Form.Group>
    ...
    return (
      <div>
        <Card className="mt-0 pt-0">
          <Card.Header>
            <img src={bannerImg} width="100%" height="160px" alt="" />
            ...
            <div className="row">
              <div className="col-sm-12 col-md-9 col-lg-9 proContainer">
                ...
                <Typography
                  variant="subtitle1"
                  className="mt-2 custom-username"
                >
          ...
          <Card.Body>
            ...
            <div className="card mt-2 p-4">
              ...
              {!this.state.userDetails.city === null ? (
                <Typography>
                  {this.state.userDetails.city},{this.state.userDetails.region}
                </Typography>
              ) : null}
            </div>
