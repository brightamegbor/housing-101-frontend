    ...
    <div className="container">
      ...
      <Form className="mb-4 pb-4">
        ...
        <Grid>
          ...
          <div className="">
            <ToggleButtonGroup
              ...
              className="propTypebtn propSubTypebtn"
            >
              <ToggleButton value="house" aria-label="house" className="">
                House
              </ToggleButton>
        ...
        <Grid className="mt-4 pt-4">
          <p className="mt-3 font-weight-bold">Property Location</p>
        ...
        <Grid container>
          <div className="">
            <ToggleButtonGroup
              ...
              className="propTypebtn"
            >
              <ToggleButton value="water" aria-label="water" className="">
                Water
              </ToggleButton>
              ...
              <ToggleButton value="tv" aria-label="tv" className=" border-left">
                TV
              </ToggleButton>
            </ToggleButtonGroup>
          </div>
        ...
        <Grid>
          ...
          <div className="">
            <ToggleButtonGroup
              ...
              className="propTypebtn propSubTypebtn"
            >
              <ToggleButton value="yes" aria-label="yes" className="">
                Yes
              </ToggleButton>

              <ToggleButton value="no" aria-label="no" className=" border-left">
                No
              </ToggleButton>
            </ToggleButtonGroup>
          </div>
        ...
        <Grid>
          ...
          <div className="">
            <ToggleButtonGroup
              ...
              className="propTypebtn propSubTypebtn"
            >
              <ToggleButton value="one-year" aria-label="one-year" className="">
                1 Year
              </ToggleButton>
        ...
        <Grid>
          ...
          <div className="">
            <ToggleButtonGroup
              ...
              className="propTypebtn propSubTypebtn"
            >
              <ToggleButton value="bathroom" aria-label="bathroom" className="">
                Bathroom
              </ToggleButton>
        ...
        <Grid>
          ...
          <div className="">
            <ToggleButtonGroup
              ...
              className="propTypebtn propSubTypebtn"
            >
              <ToggleButton value="in-built" aria-label="in-built" className="">
                In Built
              </ToggleButton>
...
function StepContent2() {
  ...
  return (
    <div className="container">
      <Form className="mb-4 pb-4">
        <p>Upload at least 3 high resolution images in JPG or PNG format</p>
